        ...
        <div className="flex overflow-hidden">
          ...
          <div className="absolute top-0 flex justify-between items-center w-full h-full ">
            <div className="p-2 ml-4 bg-gray-200 rounded-full hover:bg-gray-300 hover:cursor-pointer ">
              <svg onClick={previousSlide} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className="absolute bottom-0 py-4 flex justify-center w-full gap-3 ">
              {
                slides.map((s, i)=>{
                  return(
                    ...
                    key={"circle" + i} 
                    className={`rounded-full w-3 h-3 cursor-pointer  ${ i == current ? "bg-gray-200" : "bg-gray-500" }`}
            ...
            <div className="absolute top-[10%] left-[15%]  xl:top-[30%] xl:left-[15%]">
              {
                ...
                <div className="txt-gray-200">
                    ...
                    <p className="mb-2 text-xs italic">Last call for upto 15% off</p>
                    <span className="bg-gray-600 hover:bg-gray-700 px-4 py-2 rounded-full  text-white ">shop now</span>
                </div>
              }
            </div>
